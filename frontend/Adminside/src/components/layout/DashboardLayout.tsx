...
import { Bell, UserCircle, ChevronDown, LogOut, Settings, Moon, Sun, LayoutDashboard, Users, CalendarDays, ImageIcon, LogOutIcon,FileTextIcon  } from 'lucide-react';
        ...
        <nav className="flex-1 px-4 py-6">
          <ul className="space-y-6">
            ...
            <li>
             ...
             <li>
              <Link to="/logs" className={`flex items-center text-xl ${isActive('/logs')}`}>
